...
// ─── Company Model (from MarketWatch API) ─────────────────────────────────────
class _Company {
      ...
      if (res.statusCode == 200 && data['responseCode'] == 200) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          ...
          content: Row(children: [
            ...
            Expanded(
              child: Text(
                '${_tradeType == _TradeType.buy ? "Buy" : "Sell"} order placed for '
                    '${_selected!.code}  ·  #${data['OrderId']}',
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          ...
          shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(12)),
          content: Text(
            data['responseMessage']?.toString() ?? 'Order failed. Please try again.',
            style: const TextStyle(
                color: Colors.white, fontWeight: FontWeight.w600),
          ),
        ));
                                        ...
                                        child: Row(
                                            children: [
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  Text(
                                                      'E ${c.currentPrice.toStringAsFixed(2)}',
                                                      style: const TextStyle(
                                                          fontSize:
                                                          12.5,
                                                          fontWeight:
                            ...
                            child: GestureDetector(
                              onTap: () => setState(() {
                                ...
                                if (t.$1 == _OrderType.market &&
                                    _selected != null) {
                                  _priceCtrl.text = _selected!.currentPrice
                                      .toStringAsFixed(2);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(children: [
        ...
        if (broker != null) _SumRow('Broker', broker!.companyName),
        _SumRow('Action',
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: enabled
                ...
                const Color(0xFF155229)
              ]
                  : [
                const Color(0xFF3D0808),
                const Color(0xFF6B1111)
              ]
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border:
            Border.all(color: accent.withOpacity(0.30), width: 1.5),
          ),
          child: Icon(
            tradeType == _TradeType.buy
                ? Icons.trending_up_rounded
        ...
        Container(
          ...
          child: Column(children: [
            ...
            const SizedBox(height: 10),
            _SheetRow(
                label: 'Broker', value: broker.companyName),
            const SizedBox(height: 10),
            _SheetRow(
                label: 'Shares',
